        ...
        <ul class="products">
            ...
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Em Muốn Làm Con Ngoan</a>
                        <a href="" class="product-name"></a>
            ...
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Chờ Đến Mẫu Giáo Thì Đã Muộn</a>
                        <a href="" class="product-name"></a>
            ...
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Thay Mẹ Cha Gánh Vác Sơn Hà</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">47.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Mỗi Lần Vấp Ngã Là Một Lần Trưởng Thành</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">58.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Tự Tin Ở Đâu Xa, Tớ Ở Ngay Đây Mà</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">66.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Đu Đưa Trên Ngọn Cây Bàng</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">61.000 VND</div>
                    </div>
                </div>
            </li>
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Ngôi Nhà Trong Cỏ</a>
                        <a href="" class="product-name"></a>
            ...
            <li>
                <div class="product-item">
                    ...
                    <div class="product-info">
                        <a href="" class="product-cat">Chúc Một Ngày Tốt Lành</a>
                        <a href="" class="product-name"></a>
                        <div class="product-price">63.000 VND</div>
                    </div>
                </div>
            </li>
        </ul>
