	...
	<h2>Cập Nhật Thông Tin Sinh Viên</h2>
				 ...
				 <div class="form-group">
					...
					<div class="form-group">
							...
							<div class="col-sm-10">
								  <input type="text" name="txtClass" id="txtID" class="form-control" placeholder="Catepgy ID"
				 ...
				 <div class="form-group">
							...
							<div class="col-sm-10">
								  <input type="text" name="txtFax" id="txtName" class="form-control" placeholder="Catepgy Name" 
                    ...
                    <div class="form-group">
							...
							<div class="col-sm-10">
								  <input type="text" name="txtBook" id="txtDes" class="form-control" placeholder="Description"
    ...
    ?>
      <div class="product_footer" style="margin-top: 80px;">
            ...
            <div class="introduce">
                ...
                <div class="sdt">
                <i class='bx bx-chevron-right'></i><span>Giới thiệu về nhà sách Sinh Viên chi nhánh Việt Trì</span> <br>
