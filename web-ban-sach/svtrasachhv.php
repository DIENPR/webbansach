...
<div class="container" style="margin-top: 30px;">
				 ...
				 <div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2">
                              ...
                              <input type="button" class="btn btn-primary" name="btnIgnore"  id="btnIgnore" value="Cancel" onclick="window.location='svmuonsach1.php'" />
    ...
    <div class="product_footer" style="margin-top: 100px;">
            <div class="hotline">
                ...
                <i class='bx bx-chevron-right'></i><span>Email: dien11072023@gmail.com</span>
                </div>
